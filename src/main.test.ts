...
describe("allocate()", () => {
    it("allocate function should map input object keys according to the provided mapping", () => {
        expect(allocate({_a: true}, {"_a": "a"})).toEqual({a: true})
    })

    it("allocate function should correctly map nested input object keys according to the provided mapping", () => {
    ...
    it("allocate function should correctly map nested array fields according to the provided mapping", () => {
